  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> activationPageUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final activationPageUsersRecord =
            activationPageUsersRecordList.isNotEmpty
                ? activationPageUsersRecordList.first
                : null;
                    ...
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await activationPageUsersRecord!.reference
