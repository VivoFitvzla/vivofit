    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(32.0, 64.0, 32.0, 32.0),
              child: Container(
                ...
                child: Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/Recurso_6@3x.png',
                      width: 70.0,
                      height: 70.0,
                      fit: BoxFit.contain,
                    ),
                                                  ...
                                                  children: [
                                                    Expanded(
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'AUTH_PAGE_PAGE_CREAR_CUENTA_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
                                                  ...
                                                  Expanded(
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'AUTH_PAGE_PAGE_INGRESAR_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
                                                          ...
                                                          if (isBiometricSupported) {
                                                            try {
                                                              _model.biometricFinger =
                                                                  await localAuth
                                                                      .authenticate(
                                                                          localizedReason:
                                                                              'Coloca tu huella para poder accerder');
                                                          ...
                                                          if (_model
                                                            ...
                                                            ScaffoldMessenger
                                                              ...
                                                              SnackBar(
                                                                content: Text(
                                                                  'La verificación a fallado, vuelva a intentarlo',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodySmall
                                                                      .override(
